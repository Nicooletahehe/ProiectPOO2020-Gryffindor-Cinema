...
void harry_intro() {
	...
	for (int j = 0; j < 80; j++) {
		...
		string quote = "Play Life Like Gryffindor Plays Quidditch. ALWAYS WIN.";
		int pQuote = (80 - size(quote)) / 2;
		for (int i = 0; i < pQuote; i++) {
			cout << " ";
		}
		cout << quote;
		for (int i = 0; i < pQuote; i++) {
...
void intro() {
	...
	/*	"   __|             _| _| _)            |                __| _)                           ",
		"  (_ |   _| |  |   _| _|  |    \    _` |   _ \   _|    (     |    \    -_)   ` \    _` |",
		"\___| _|  \_, | _| _|   _| _| _| \__,_| \___/ _|     \___| _| _| _| \___| _|_|_| \__,_| ",
		"           ___/                                                                          "*/
		"                                                                               ",
		"                                                                               ",
		...
		"                                                                               ",
		"                                                                               ",
		"   __ _____   _____ ___ _ __  _ __   __  ___    ____ __  _ ___ __ __  __       ",
		"  / _] _ \\ `v' / __| __| |  \\| | _\\ /__\\| _ \\  / _/ |  \\| | __|  V  |/  \\      ",
		" | [/\\ v /`. .'| _|| _|| | | ' | v | \\/ | v / | \\_| | | ' | _|| \\_/ | /\\ |     ",
		"  \\__/_|_\\ !_! |_| |_| |_|_|\\__|__/ \\__/|_|_\\  \\__/_|_|\\__|___|_| |_|_||_|     ",
		"                                                                               ",
		"                                                                               "
	};
	for (int i = 0; i < size(ceva); i++) {
		cout << ceva[i] << endl;
	};
	Sleep(2000);
	system("CLS");
